...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TriggerMetadata) DeepCopyInto(out *TriggerMetadata) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TriggerMetadata.
func (in *TriggerMetadata) DeepCopy() *TriggerMetadata {
	if in == nil {
		return nil
	}
	out := new(TriggerMetadata)
	in.DeepCopyInto(out)
	return out
}
